  ...
  return (
    <div>
      <div
        ...
        <div className='flex  xl:justify-around justify-between  w-full p-4 place-self-center bg-[#0A0F1C] fixed top-0 z-50 '>
          {Tabs.map((tab) => (
            tab.isSection ? (
              <a
                key={tab.id}
        ...
        <div className='flex flex-col xl:place-items-center place-items-start xl:space-y-7 space-y-3 w-7/12 xl:p-15 p-5 backdrop-blur-lg mt-9 flex-1 '>
